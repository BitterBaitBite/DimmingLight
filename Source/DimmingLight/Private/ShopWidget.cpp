...
void UShopWidget::NativeConstruct() {
	...
	// Event binding
	QuitButton->OnClicked.AddDynamic(this, &UShopWidget::OnQuit);

	GameInstance->CurrencyChangeDelegate.AddDynamic(this, &UShopWidget::OnCurrencyChange);
...
void UShopWidget::OnCurrencyChange(int32 NewCurrencyValue) {
	CurrencyText->SetText(FText::AsNumber(NewCurrencyValue));
}

void UShopWidget::OnQuit() {
	OnShopQuitDelegate.Broadcast();
}
