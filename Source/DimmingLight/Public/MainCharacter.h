...
class DIMMINGLIGHT_API AMainCharacter : public ACharacter, public IDamageable {
	...
	public:
		...
		UParticleSystemComponent* PlayParticleSystem(UParticleSystem* Effect, FName SocketName);

		UPROPERTY(Transient, SkipSerialization)
		UParticleSystemComponent* SpecialAttackArmTrail;
		UPROPERTY(Transient, SkipSerialization)
		UParticleSystemComponent* SpecialAttackHandTrail;
		UPROPERTY(Transient, SkipSerialization)
		UParticleSystemComponent* SpecialAttackHoldLoop;
		...
		virtual void ReceiveDamage_Implementation(float RawDamage, EDamageType DamageType) override;
		...
		UPROPERTY(EditAnywhere, Category="Light movement")
		FVector MovementOffset = FVector(0.f, 0.f, 25.f);
		UPROPERTY(EditAnywhere, Category="Light movement")
		float OscilatingSpeed = 1.f;
		UPROPERTY(EditAnywhere, Category="Light movement")
